...
library Constants {
    ...
    /// sqrtPriceX96 A Fixed point Q64.96 number representing the sqrt of the price of the two assets (currency1/currency0)
    ...
    uint160 public constant SQRT_PRICE_4_1 = 158456325028528675187087900672; // tick = 13863
    ...
    uint160 public constant SQRT_PRICE_1000_100 = 250541448375047931186413801569; // tick = 23027
    ...
    uint160 public constant SQRT_PRICE_1000000000_1 = 2505414483750479311864138015696063; // tick = 207243
    uint160 public constant SQRT_PRICE_1000000000_5 = 1120455419495722798374638764549163; // tick = 191147
    uint160 public constant SQRT_PRICE_1000000000_10 = 792281625142643375935439503360000; // tick = 184216
